...
Chaque vue a maintenant une seule responsabilité : parler HTTP (lire la
requête, rediriger, choisir un template). Validation, tarification et
persistance sont délégués à RendezVousForm et RendezVousService (SRP).
Le flag MODE_EXPERIMENTAL de la version de départ a été supprimé : il
n'était utilisé nulle part (YAGNI).
"""
